            ...
            if merit_bits[14]:
                s_ac_swing_mode.extend(
                    [
                        ...
                        ToshibaAcSwingMode.HADA_CARE_FLOW,
                        ToshibaAcSwingMode.LOUVER_OFF,
                        ToshibaAcSwingMode.LOUVER_UD_TOP,
                        ToshibaAcSwingMode.LOUVER_UD_UPPER,
                        ToshibaAcSwingMode.LOUVER_UD_MIDDLE,
                        ToshibaAcSwingMode.LOUVER_UD_LOWER,
                        ToshibaAcSwingMode.LOUVER_UD_BOTTOM,
                        ToshibaAcSwingMode.LOUVER_LR_LEFT_MAX,
                        ToshibaAcSwingMode.LOUVER_LR_LEFT,
                        ToshibaAcSwingMode.LOUVER_LR_CENTER,
                        ToshibaAcSwingMode.LOUVER_LR_RIGHT,
                        ToshibaAcSwingMode.LOUVER_LR_RIGHT_MAX,
                        ToshibaAcSwingMode.LOUVER_TOP_LEFT_MAX,
                        ToshibaAcSwingMode.LOUVER_TOP_LEFT,
                        ToshibaAcSwingMode.LOUVER_TOP_CENTER,
                        ToshibaAcSwingMode.LOUVER_TOP_RIGHT,
                        ToshibaAcSwingMode.LOUVER_TOP_RIGHT_MAX,
                        ToshibaAcSwingMode.LOUVER_UPPER_LEFT_MAX,
                        ToshibaAcSwingMode.LOUVER_UPPER_LEFT,
                        ToshibaAcSwingMode.LOUVER_UPPER_CENTER,
                        ToshibaAcSwingMode.LOUVER_UPPER_RIGHT,
                        ToshibaAcSwingMode.LOUVER_UPPER_RIGHT_MAX,
                        ToshibaAcSwingMode.LOUVER_MIDDLE_LEFT_MAX,
                        ToshibaAcSwingMode.LOUVER_MIDDLE_LEFT,
                        ToshibaAcSwingMode.LOUVER_MIDDLE_CENTER,
                        ToshibaAcSwingMode.LOUVER_MIDDLE_RIGHT,
                        ToshibaAcSwingMode.LOUVER_MIDDLE_RIGHT_MAX,
                        ToshibaAcSwingMode.LOUVER_LOWER_LEFT_MAX,
                        ToshibaAcSwingMode.LOUVER_LOWER_LEFT,
                        ToshibaAcSwingMode.LOUVER_LOWER_CENTER,
                        ToshibaAcSwingMode.LOUVER_LOWER_RIGHT,
                        ToshibaAcSwingMode.LOUVER_LOWER_RIGHT_MAX,
                        ToshibaAcSwingMode.LOUVER_BOTTOM_LEFT_MAX,
                        ToshibaAcSwingMode.LOUVER_BOTTOM_LEFT,
                        ToshibaAcSwingMode.LOUVER_BOTTOM_CENTER,
                        ToshibaAcSwingMode.LOUVER_BOTTOM_RIGHT,
                        ToshibaAcSwingMode.LOUVER_BOTTOM_RIGHT_MAX,
                        ToshibaAcSwingMode.LOUVER_SWING_UD,
                        ToshibaAcSwingMode.LOUVER_SWING_LR,
                        ToshibaAcSwingMode.LOUVER_SWING_BOTH,
                    ]
                )
